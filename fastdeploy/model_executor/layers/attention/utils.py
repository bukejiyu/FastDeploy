...
def split_decodes_and_prefills(
    ...
    """
    num_running_requests = forward_meta.num_running_requests
    seq_lens_this_time_running = forward_meta.seq_lens_this_time[:num_running_requests]
    seq_lens_encoder_running=forward_meta.seq_lens_encoder[:num_running_requests]
    actual_token_nums=paddle.sum(seq_lens_this_time_running).item()
    ...
    num_decode_tokens = paddle.sum(seq_lens_this_time_running[:first_prefill]).item()
